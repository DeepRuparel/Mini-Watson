...
public class IndexCreator {
        ...
        while(sc.hasNextLine()){
            ...
            if (s1.length()>4 && s1.substring(0,2).equals("[[") && s1.substring(len - 2, len).equals("]]")){
                ...
                if(!title.contains("file:") && !title.contains("image:")){
                    //System.out.println("Title:"+title+"Categories:"+categories+"Content:"+material+"\n");
                    //titles=title;
    ...
    public static void main(String[] args) throws IOException {
        ...
        //QueryProcess queryProcess = new QueryProcess("src/main/resources/query");
        //queryProcess.evalQuery();
    }
}
